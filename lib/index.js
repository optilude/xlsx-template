...
module.exports = (function() {
    ...
    Workbook.prototype._rebuildIndexes = function(){
      ...
      this.workbook.findall("sheets/sheet").forEach(function(item, index) {
...
//	  	console.log(self.workbook.findall('definedNames/definedName'));
			return self
    };
