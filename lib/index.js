...
module.exports = (function() {
    ...
    var PREFIX         = "xl/",
        SHARED_STRINGS = PREFIX + "sharedStrings.xml",
        WORKBOOK       = PREFIX + "workbook.xml",
        WORKBOOK_RELS  = PREFIX + "_rels/workbook.xml.rels";
    ...
    Workbook.prototype.substitute = function(sheet, substitutions) {
        ...
        var file = PREFIX + self.getSheetFilename(sheet),
    ...
    Workbook.prototype.getSheetFilename = function(sheet) {
        ...
        var workbook = etree.parse(self.archive.file(WORKBOOK).asText()).getroot(),
            rels     = etree.parse(self.archive.file(WORKBOOK_RELS).asText()).getroot();

        var sheetReference = (typeof(sheet) === "number") ?
                workbook.find("sheets/sheet[@sheetId='" + sheet + "']") :
                workbook.find("sheets/sheet[@name='" + sheet + "']");
        ...
        var sheetId = sheetReference.attrib['r:id'],
            relationship = rels.find("Relationship[@Id='" + sheetId + "']");
