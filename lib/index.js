                        ...
                        placeholders.forEach(function(placeholder) {
                            ...
                            if(substituted !== null) {
                                ...
                                if(placeholder.type === "table") { // multiple rows
                                    ...
                                    // * Loop over substitution array
                                    // * If no elements, replace with empty cell
                                    // * Else, first element replaces placeholder
                                    // * For each additional element, find a target row by:
                                    //     * if a new row has already been inserted, pick this
                                    //     * else create a new row and remember it
                                    // * In this row, add a clone of the placeholder cell with the next element value
