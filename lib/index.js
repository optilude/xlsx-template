...
module.exports = (function() {
    ...
    */
    ...
    /**
     * Handled the image substitution (if needed)
     * @param {any} substitution : current substitution image
     * @param {Error} error : Error was throw from imageToBuffer
     */
    Workbook.prototype.handleImageError = function (substitution, error) {
        throw error;
    }
    ...
    Workbook.prototype.substituteImage = function (cell, string, placeholder, substitution, drawing) {
        ...
        try {
            ...
            substitution = self.handleImageError(substitution, error);
        }
